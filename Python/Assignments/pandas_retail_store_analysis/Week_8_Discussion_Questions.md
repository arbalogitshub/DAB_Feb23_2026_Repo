...
To ensure my work is reproducible, I would document my data cleaning process in a Markdown/ Jupyter Notebook file that would include code with easy to understand comments, Results of code that ran (snippets of data) to esnure clarity.
